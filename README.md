# Régulateur Tension fixe 12V (DC)

Ce repository enregistre les différents fichiers réalisés sous SimulIDE de notre projet proposé pour réaliser un étage de régulation de tension fixe avec un composant générique, analyser la tension à la sortie de l'étage tout en jouant avec la tension VGen injectée à l'entrée de ce régulateur.
Plus de détails, vous pouvez vous faire référence à article de découverte : <a href="https://electro-robot.com/les-activites/regulateur-de-tension-12v-dc">https://electro-robot.com/les-activites/regulateur-de-tension-12v-dc</a>
